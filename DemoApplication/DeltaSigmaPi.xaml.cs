...
{
    /// <summary>
    /// This demonstration shows how to read from the Delta-Sigma Pi and update the bit rate and gain.
    /// </summary>
    public sealed partial class DeltaSigmaPi : Page
    {
        // create an instance of the DeltaSigmaPi class called adc
        ABElectronics_Win10IOT_Libraries.DeltaSigmaPi adc = new ABElectronics_Win10IOT_Libraries.DeltaSigmaPi();
