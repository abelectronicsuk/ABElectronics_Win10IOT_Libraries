...
namespace DemoApplication
{
    ...
    /// </summary>
    public sealed partial class ADCDifferentialPi : Page
    {
        // create an instance of the ADCDifferentialPi class called adc
        ABElectronics_Win10IOT_Libraries.ADCDifferentialPi adc = new ABElectronics_Win10IOT_Libraries.ADCDifferentialPi();
